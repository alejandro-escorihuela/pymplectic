...
if __name__ == "__main__":
    ...
    plt.suptitle(r"Efici\`encia de m\`etodes $\hat{\mathcal{R}}^n(\mathcal{SS}^{[4]}_3)$. $\displaystyle\log_{10}($Error$)$ vs $\displaystyle\log_{10}\left(N_{\rm{eval}}\right)$", fontsize = 16)

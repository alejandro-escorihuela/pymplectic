...
plot "../dat/r1_s2/kepl_cons_1000000_01.dat" u (log10($1)):(log10(abs($3))) w l t "r1 s2", \
     "../dat/sc_3_4/kepl_cons_1000000_01.dat" u (log10($1)):(log10(abs($3))) w l t "sc 34", \
     "../dat/ssc_3_4/kepl_cons_1000000_01.dat" u (log10($1)):(log10(abs($3))) w l t "ssc 34"

...
if __name__ == "__main__":
    met = ["s_3_4", "r1_ss4", "r2_ss4", "r3_ss4", "r4_ss4"]
    nom = [r"\mathcal{SS}^{[4]}_3", r"\hat{\mathcal{R}}^1(\mathcal{SS}^{[4]}_3)", r"\hat{\mathcal{R}}^2(\mathcal{SS}^{[4]}_3)", r"\hat{\mathcal{R}}^3(\mathcal{SS}^{[4]}_3)",  r"\hat{\mathcal{R}}^4(\mathcal{SS}^{[4]}_3)"]
    t = []
    Neval = []
    H = []
